...
async def get_recent_reports():
    ...
    try:
        # Mock recent reports data for now
        # In a real implementation, this would fetch from a database
        recent_reports = [
            {
                "id": "esg_report_20240101_120000",
                ...
                "file_size": "2.4 MB",
                "format": "PDF",
                "download_url": "/api/reports/download/esg_report_20240101_120000"
            },
            {
                "id": "esg_report_20231215_143000",
                ...
                "file_size": "1.8 MB",
                "format": "PDF",
                "download_url": "/api/reports/download/esg_report_20231215_143000"
            },
            {
                "id": "esg_report_20231201_090000",
                ...
                "file_size": "2.1 MB",
                "format": "PDF",
                "download_url": "/api/reports/download/esg_report_20231201_090000"
            },
            {
                "id": "esg_report_20231115_160000",
                ...
                "file_size": "1.5 MB",
                "format": "PDF",
                "download_url": "/api/reports/download/esg_report_20231115_160000"
            },
            {
                "id": "esg_report_20231101_110000",
                ...
                "file_size": "1.9 MB",
                "format": "PDF",
                "download_url": "/api/reports/download/esg_report_20231101_110000"
            }
        ]
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch recent reports")
